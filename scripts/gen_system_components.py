...
def render(doc, features, known_topics):
    ...
    timestamp = _stable_now_timestamp([DATA_JSON, FEATURES_JSON])
    updated = stable_updated_date([DATA_JSON, FEATURES_JSON])
    ...
    lines.append("---\n")
    lines.append(
        f"<!-- generated by scripts/gen_system_components.py; do not edit by hand (source ts: {timestamp}) -->"
    )
    lines.append("")
