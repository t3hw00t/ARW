...
def render_catalog(catalog: dict, features: dict) -> str:
    timestamp = _stable_now_timestamp([FEATURES_JSON, CATALOG_JSON])
    updated = stable_updated_date([FEATURES_JSON, CATALOG_JSON])
    out = []
    out.append("---")
    out.append("title: Universal Feature Catalog")
    out.append("---\n")
    out.append(
        f"<!-- generated by scripts/gen_feature_catalog.py; do not edit by hand (source ts: {timestamp}) -->"
    )
    out.append("")
