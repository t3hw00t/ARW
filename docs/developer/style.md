...
- Registry checks: `just check-system-components` (or `just docgen`; Windows shells without Bash can run `powershell -ExecutionPolicy Bypass -File scripts\docgen.ps1`) must pass before submitting component/feature doc updates.
