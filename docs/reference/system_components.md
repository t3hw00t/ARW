...
<!-- generated by scripts/gen_system_components.py; do not edit by hand (source ts: 2025-10-02T11:01:23+02:00) -->
...
- HTTP:
  ...
  - `POST /admin/policy/capsules/teardown`
  - `POST /leases`
  - `GET /state/leases`
- Environment:
  - `ARW_POLICY_FILE`
