...
<!-- generated by scripts/gen_system_components.py; do not edit by hand -->

_Last updated: 2025-09-17T18:49:19Z_

# System Components

This page is generated from [interfaces/system_components.json](https://github.com/t3hw00t/ARW/blob/main/interfaces/system_components.json) and reconciled with [interfaces/features.json](https://github.com/t3hw00t/ARW/blob/main/interfaces/features.json) plus topic constants in [`crates/arw-topics`](../../crates/arw-topics/src/lib.rs).
...
| Asimov Capsule Guard | [Asimov Capsule Guard](../feature_matrix.md#asimov-capsule-guard)<br /><small>Future pack</small> | Security & Policy | Future pack / runtime / operators / guardrails / plan | platform | ANY /admin/* (X-ARW-Gate)<br />policy.decision<br />rpu.trust.changed<br />… | [architecture/asimov_capsule_guard.md](../architecture/asimov_capsule_guard.md) |
...
| SSE + JSON Patch Streaming Contract | [Event Spine](../feature_matrix.md#event-spine)<br /><small>Core kernel</small> | Runtime | Core kernel / runtime / developers / data plane / beta | platform | GET /admin/events<br />state.read.model.patch | [architecture/sse_patch_contract.md](../architecture/sse_patch_contract.md) |
...
| Agent Orchestrator | [Orchestrator Plane](../feature_matrix.md#orchestrator-plane)<br /><small>Remote collaborator pack</small> | Runtime | Remote collaborator pack / runtime / developers / orchestration / plan | platform | GET /orchestrator/mini_agents<br />POST /orchestrator/mini_agents/start_training<br />GET /state/orchestrator/jobs<br />task.completed | [architecture/agent_orchestrator.md](../architecture/agent_orchestrator.md) |
...
| Context Working Set | [Working Set Builder](../feature_matrix.md#working-set-builder)<br /><small>Core kernel</small> | Runtime | Core kernel / runtime / developers / context / plan | platform | GET /context/assemble<br />GET /admin/context/assemble<br />POST /context/rehydrate<br />working_set.started<br />working_set.seed<br />… | [architecture/context_working_set.md](../architecture/context_working_set.md) |
...
- Notes:
  - Admin-gated `GET /admin/events` streams with corr_id stitching keep timelines authoritative.
