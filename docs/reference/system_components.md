...
_Last updated: 2025-09-17T17:46:23Z_
...
- Signals & Telemetry:
  ...
  - `policy.capsule.expired` ⚠
- HTTP:
  - `ANY /admin/* (X-ARW-Gate)`
  - `/state/policy/capsules`
- Environment:
  - `ARW_TRUST_CAPSULES`
  - `ARW_GATING_DENY`
- Topics:
