...
_Last updated: 2025-09-17T01:13:47+02:00_
...
- Scope: Core / backend / admin / core / complete
- Owner: platform
- Depends on:
  - event_spine
  - guardrail_gateway
...
- Scope: Core / backend / dev / connectivity / complete
- Owner: platform
- Single Sources of Truth:
...
- Scope: Core / backend / dev / core / complete
- Owner: platform
- Depends on:
  - event_spine
- Single Sources of Truth:
...
- Scope: Extension / backend / admin / auxiliary / complete
- Owner: platform
- Depends on:
  - event_spine
- Single Sources of Truth:
...
- Scope: Core / backend / admin / helpers / complete
- Owner: platform
- Depends on:
  - event_spine
- Single Sources of Truth:
...
- Scope: Extension / backend / admin / core / complete
- Owner: platform
- Depends on:
  - event_spine
- Single Sources of Truth:
...
- Scope: Core / backend / admin / connectivity / complete
- Owner: platform
- Depends on:
  - event_spine
- Single Sources of Truth:
...
- Scope: Extension / backend / admin / connectivity / partial
- Owner: platform
- Depends on:
  - event_spine
- Single Sources of Truth:
...
- Scope: Future / backend / admin / security / alpha
- Owner: platform
- Depends on:
  - guardrail_gateway
  - policy_leases
...
- Scope: Extension / backend / dev / connectivity / complete
- Owner: platform
- Depends on:
  - event_spine
- Single Sources of Truth:
...
- Scope: Core / dev / dev / auxiliary / complete
- Owner: platform
- Single Sources of Truth:
...
- Scope: Core / backend / dev / core / beta
- Owner: platform
- Depends on:
  - event_spine
- Single Sources of Truth:
...
- Scope: Core / backend / admin / security / beta
- Owner: platform
- Depends on:
  - triad_kernel
- Single Sources of Truth:
...
- Scope: Core / backend / builder / intelligence / beta
- Owner: platform
- Depends on:
  - triad_kernel
- Single Sources of Truth:
...
- Scope: Core / backend / admin / core / beta
- Owner: platform
- Depends on:
  - triad_kernel
- Single Sources of Truth:
...
- Scope: Extension / backend / admin / core / beta
- Owner: platform
- Depends on:
  - config_plane
- Single Sources of Truth:
...
- Scope: Extension / backend / admin / connectivity / beta
- Owner: platform
- Depends on:
  - policy_leases
  - egress_sentinel
...
- Scope: Future / runtime / dev / core / alpha
- Owner: platform
- Depends on:
  - egress_sentinel
- Single Sources of Truth:
