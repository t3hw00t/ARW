...
#[derive(Deserialize)]
pub(crate) struct SetProfile { name: String }
...
#[derive(Deserialize)]
pub(crate) struct Hints { #[serde(default)] max_concurrency: Option<usize>, #[serde(default)] event_buffer: Option<usize>, #[serde(default)] http_timeout_secs: Option<u64> }
