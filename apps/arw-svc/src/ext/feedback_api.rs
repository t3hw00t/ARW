...
#[derive(Deserialize)]
pub(crate) struct FeedbackSignalPost { kind: String, target: String, confidence: f64, severity: u8, note: Option<String> }
...
#[derive(Deserialize)]
pub(crate) struct ApplyReq { id: String }
...
#[derive(Deserialize)]
pub(crate) struct AutoReq { enabled: bool }
