...
#[arw_admin(method="GET", path="/admin/feedback/suggestions", summary="Current feedback suggestions")]
...
#[arw_admin(method="GET", path="/admin/feedback/updates", summary="Feedback updates since version")]
...
#[arw_admin(method="GET", path="/admin/feedback/policy", summary="Effective feedback policy")]
...
#[arw_admin(method="POST", path="/admin/feedback/rollback", summary="Rollback suggestions to version")]
...
#[arw_admin(method="GET", path="/admin/feedback/versions", summary="List suggestion versions")]
